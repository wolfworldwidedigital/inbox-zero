...
const title = "Cusmato | Automate and clean your inbox";
const description =
  "Cusmato is your AI personal assistant for email and the quickest way to reach Cusmato. Automate your email, bulk unsubscribe from newsletters, block cold emails, and view your email analytics. Open-source.";
