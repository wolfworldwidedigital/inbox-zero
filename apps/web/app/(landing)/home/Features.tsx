...
const features = [
  {
    ...
    description:
      "Tell Cusmato how to handle your emails and it will do it for you. Automatically reply, archive, and label emails based on your instructions.",
    icon: Sparkles,
  },
  {
    name: "Automatically archive cold emails",
    description:
      "Sick of cold emails? Cusmato can automatically archive and label them for you so they don't clog your inbox.",
    icon: Orbit,
  },
  {
    name: "Explain it in plain English",
    description:
      "Tell Cusmato how to handle your emails in plain English. It's as simple as writing to an assistant or ChatGPT.",
    icon: LineChart,
  },
];
    ...
    <div className="bg-white py-24 sm:py-32" id="features">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Cusmato has undergone a thorough security process with Google to
...
export function FeaturesAutomation() {
  return (
    <FeaturesWithImage
      ...
      description="Keep getting emails that require the same response? Let Cusmato handle it."
...
const featuresColdEmailBlocker = [
  ...
  },
  {
    ...
    description:
      "Tell Cusmato what constitutes a cold email for you. It will block them based on your instructions.",
    icon: SparklesIcon,
  },
  {
